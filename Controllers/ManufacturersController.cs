...
public class ManufacturersController : Controller
{
    ...
    public ManufacturersController(MaintenanceReminderContext context)
    {
        _context = context;
    }
    ...
    public async Task<IActionResult> Index()
    {
        return _context.Manufacturer != null ? 
            ...
            Problem("Entity set 'MaintenanceReminderContext.Manufacturer'  is null.");
    }
    ...
    public async Task<IActionResult> DeleteConfirmed(int id)
    {
        ...
        {
            return Problem("Entity set 'MaintenanceReminderContext.Manufacturer'  is null.");
        }
        var manufacturer = await _context.Manufacturer.FindAsync(id);
        if (manufacturer != null)
        {
